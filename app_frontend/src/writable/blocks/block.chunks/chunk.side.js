...
const Side = ( { curr } ) => {
    ...
    const handleMouseDown = evt => {
        let editableParent = evt.currentTarget.parentNode;
        editableParent.setAttribute( 'draggable', 'true' );
    }

    const handleMouseUp = evt => {
        let editableParent = evt.currentTarget.parentNode;
        editableParent.setAttribute( 'draggable', 'false' );
    }
    ...
    useEffect( ( ) => {
        ...
        return ( ) => {
          ...
          curr_ref.current.removeEventListener( 'mouseend'  , handleDragEnd );
        }
    } , [ ] );
